...
int bd_rmdir(const char *pFilename)
{
	...
	pathParentDirectory = calloc(strlen(pFilename), sizeof(char));
...
int bd_rename(const char *pFilename, const char *pDestFilename)
{
	...
	pathSourceDirectory = calloc(strlen(pFilename), sizeof(char));
	pathDestinationDirectory = calloc(strlen(pDestFilename), sizeof(char));
